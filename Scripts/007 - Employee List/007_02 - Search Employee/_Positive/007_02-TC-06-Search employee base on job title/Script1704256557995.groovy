...
WebUI.click(findTestObject('007-TC-Employee List/007_02_TC-search_Employee/Page_OrangeHRM/span_arrow_Job_Title'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('007-TC-Employee List/007_02_TC-search_Employee/Page_OrangeHRM/div_Chief Executive Officer'))
