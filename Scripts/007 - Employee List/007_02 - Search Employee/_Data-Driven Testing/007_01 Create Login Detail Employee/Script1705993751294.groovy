...
WebUI.setText(findTestObject('Object Repository/007-TC-Employee List/007_01-TC-employee_List/Page_OrangeHRM/007_01-TC-01-employee_login/Page_OrangeHRM/input_Password_oxd-input oxd-input--active'), 
    input_password)

WebUI.setText(findTestObject('007-TC-Employee List/007_01-TC-employee_List/Page_OrangeHRM/007_01-TC-01-employee_login/Page_OrangeHRM/input_Confirm Password_oxd-input oxd-input--focus'), 
    confirm_password)
