...
WebUI.uploadFile(findTestObject('007-TC-Employee List/007_01-TC-employee_List/Page_OrangeHRM/button_Add Employee_oxd-icon-button oxd-icon-button--solid-main employee-image-action'), 
    gambar)
