...
WebUI.click(findTestObject('007-TC-Employee List/007_02_TC-search_Employee/Page_OrangeHRM/button_Delete_Icon_Employee'))

WebUI.click(findTestObject('003-TC-User Management/003_03-TC-01-user_Delete_Account/Page_OrangeHRM/button_Yes, Delete'))

WebUI.click(findTestObject('007-TC-Employee List/007_02_TC-search_Employee/Page_OrangeHRM/button_Actions_Delete_Icon_Employee_Other'))
