...
WebUI.callTestCase(findTestCase('005 - Pay Grades/005_02 - Add Currency/_Positive/005_02-TC-01-Users successfully add new currency'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('005-TC-Pay Grades/005_02-TC-add_Currency/Page_OrangeHRM/button_Add (1)'))
