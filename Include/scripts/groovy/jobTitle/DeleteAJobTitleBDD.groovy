...
class DeleteAJobTitleBDD {
	/**
	 * The step definitions below match with Katalon sample Gherkin steps
	 */
	@Given("User successfully login to the website")
	def User_successfully_login_to_the_website() {
		
		WebUI.callTestCase(findTestCase('001 - Login/_Positive/001-TC-01-User successfully login'), [:], FailureHandling.STOP_ON_FAILURE)
		
	}

	@When("User go to job title menu")
	def User_go_to_job_title_menu() {
	...
	@When("User delete a job title")
	def User_delete_a_job_title() {
	...
	@Then("User delete a job title was successfull")
	def User_delete_a_job_title_was_successfull() {
