...
class EnterExistingJobCategoryBDD {
	/**
	 * The step definitions below match with Katalon sample Gherkin steps
	 */
	@Given("User navigate to login starting page")
	def user_navigate_login_starting_page() {
	...
	@When("User enter job category details")
	def entering_job_category_details() {
		
	WebUI.click(findTestObject('006-TC-Job Categories/006_01-TC-01-add_Job_Category/Page_OrangeHRM/button_Add'))

	WebUI.setText(findTestObject('006-TC-Job Categories/006_01-TC-01-add_Job_Category/Page_OrangeHRM/input_Name_oxd-input oxd-input--focus'), 
    'jobless2')

	WebUI.click(findTestObject('006-TC-Job Categories/006_01-TC-01-add_Job_Category/Page_OrangeHRM/button_Save'))
	
	}

	@And("User enter the previously input the existing job category details")
	def entering_existing_job_category_details() {
